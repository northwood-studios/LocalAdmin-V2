    ...
    */
    ...
    public sealed class LocalAdmin : IDisposable
    {
        ...
        public void Start(string[] args)
        {
            ...
            try
            {
                ...
                if (_firstRun)
                {
                    ...
                    CaptureArgs capture = CaptureArgs.None;
        ...
        private void SetupServer()
        {
            ...
            {
                if (!byte.TryParse(line.AsSpan(0, 1), NumberStyles.HexNumber, null, out byte colorValue))
        ...
        private void SetupReader()
        {
            _readerTask = new Task(async () =>
            {
                ...
                while (!_exit)
                {
                    ...
                    int currentLineCursor = NoSetCursor ? 0 : Console.CursorTop;
                    ...
                    if (split.Length == 0)
                        continue;
                    string? name = split[0].ToUpperInvariant();

                    CommandBase? command = _commandService.GetCommandByName(name);
        ...
        private void RunScpsl()
        {
            if (File.Exists(_scpslExecutable))
            {
                ...
                bool redirectStreams = Configuration!.LaShowStdoutStderr || Configuration!.LaLogStdoutStderr || _stdPrint;
